...
(function (global) {
  ...
  function loadState() {
    ...
    return {
      programs: Array.isArray(parsed.programs) ? parsed.programs : DEFAULT_STATE.programs,
